              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onFocus={() => searchUser.length > 2 && setShowUserResults(true)}
                ...
                {showUserResults && users.length > 0 && !selectedUser && (
                  <div className="absolute z-10 mt-1 w-full bg-white rounded-xl shadow-lg border border-gray-200 max-h-48 overflow-y-auto">
                    {users.map((user) => (
                      <button
                        ...
                        className="w-full px-4 py-2 text-left hover:bg-indigo-50 transition-colors flex items-center gap-3"
                      >
                        <Users className="w-4 h-4 text-gray-400" />
                        <div>
                          <p className="text-sm font-medium text-gray-800">{user.name}</p>
                          <p className="text-xs text-gray-500">{user.identification}</p>
                        </div>
                      </button>
                    ))}
                  </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onFocus={() => searchCopy.length > 2 && setShowCopyResults(true)}
                ...
                {showCopyResults && copies.length > 0 && !selectedCopy && (
                  <div className="absolute z-10 mt-1 w-full bg-white rounded-xl shadow-lg border border-gray-200 max-h-48 overflow-y-auto">
                    {copies.map((copy) => (
                      <button
                        key={copy.id}
                      ...
                      >
                        ...
                        <p className="text-xs font-mono text-indigo-600">{copy.code}</p>
                      </button>
                    ))}
                  </div>
                )}
