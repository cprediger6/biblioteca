...
// Usamos any para los campos que pueden no existir en producción
type UserWithRelations = {
  ...
  // status puede no existir en producción, por eso es opcional
  status?: string;
};
...
export default async function UserDetailPage({ 
  ...
  // @ts-ignore - Ignoramos el error de TypeScript porque el campo puede no existir en producción
