// components/PrintCarnetButton.tsx
"use client";

import { Printer } from "lucide-react";
import Barcode from "./Barcode";

interface PrintCarnetButtonProps {
  user: {
    id: string;
    name: string;
    email: string;
...
export default function PrintCarnetButton({ user, className = "" }: PrintCarnetButtonProps) {
  const handlePrintCarnet = () => {
    ...
    // Usar el componente Barcode para generar el SVG
          ...
          <div class="carnet">
            <div class="card-content">
              <div class="left-section">
                ${user.photo ? `
                  <img src="${user.photo}" class="photo-img" alt="Foto" />
                ` : `
                  <div class="photo">📚</div>
                `}
              ...
              <div class="right-section">
                ...
                <div>
                  ...
                  <div class="value">${user.identification}</div>
                </div>
                <div class="info-row">
                  <div class="info-col">
                    <div class="label">EMAIL</div>
                    <div class="value" style="font-size:5px;">${user.email}</div>
                  </div>
                  <div class="info-col">
                    <div class="label">TELÉFONO</div>
                    <div class="value" style="font-size:5px;">${user.phone || 'N/A'}</div>
                  </div>
                </div>
              ...
              function generateBarcode() {
                ...
                try {
                  ...
                  if (typeof JsBarcode !== 'undefined') {
                    ...
                    // Fallback si JsBarcode no está disponible
                    container.innerHTML = \`
                      <div style="font-family: monospace; font-size: 12px; letter-spacing: 2px; padding: 4px; background: #f9fafb; border: 1px solid #e5e7eb; border-radius: 4px;">
                        *${user.identification}*
                      </div>
                    \`;
                  }
